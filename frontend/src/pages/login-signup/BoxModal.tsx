...
export default function BoxModal({ close }: { close: () => void }) {
    ...
    return (
        <div className="font-baskerville fixed inset-0 bg-[rgba(37,37,37,0.5)] md:bg-[rgba(26,26,26,0.8)] 
                ...
                <div className="mx-auto">
                    ...
                    <div className="flex items-start justify-between px-4 mb-10">
                        ...
                        <div
                            ...
                            <button
                                type="button"
                                className={`text-body-14 text-gray-400 w-full text-center cursor-pointer
